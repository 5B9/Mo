...
public class ControleFuncionario {
    ...
    public boolean validarCadastroFuncionarios(String nomeUsuario, String senha) throws PersistenciaException {
        FuncionarioDAO funcionarioDAO = new FuncionarioDAO();
        return funcionarioDAO.validarCadastroFuncionarios(nomeUsuario, senha);
    }
}

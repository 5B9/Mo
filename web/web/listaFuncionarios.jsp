...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <%} else { %>
            <div class="row">
                <a href="listaFuncionarios.jsp" class="  light-blue darken-4 waves-effect waves-light btn col s6" value="" style="color: white;">Funcionários Habilitados</a>
                <a href="telaHabilitarFuncionario.jsp" class="grey lighten-5 waves-effect waves-light btn col s6" value="" style="color: gray;">Funcionários Desabilitados</a>
            </div>
            <br>
            <div class="container" >

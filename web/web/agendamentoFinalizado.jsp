...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <%} else { %>
            <div class="row">
                <a href="Agendamento.jsp" class="grey lighten-5 waves-effect waves-light btn col s6" value="" style="color: gray;">Sessões abertas</a>
                <a href="agendamentoFinalizado.jsp" class="light-blue darken-4 waves-effect waves-light btn col s6" value="" style="color: white;">Sessões finalizadas</a>
            </div>
            <br>
            <div class="container" >

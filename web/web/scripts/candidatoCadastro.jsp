...
<html>
    ...
    <body>
        <%
            ...
            Candidato candidato = new Candidato(escolaridade, cargoDesejado, idade, formacoesProfissionais, formacoesAcademicas, formacoesComplementares, tipoUsuario, 0, nomeCompleto, cpf, rg, sexo, enderecoEmail);

...
<html>
    ...
    <body>
        <%
            ...
            String tipoEntrevista  = request.getParameter("tipoEntrevista");

            Entrevista e = new Entrevista(0,tipoEntrevista, funcionario, cargo, fasePsicologica, faseTecnica, candidato, false);

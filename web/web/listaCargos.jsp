...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <%} else { %>
            <div class="row">
                <a href="listaCargos.jsp" class="  light-blue darken-4 waves-effect waves-light btn col s6" value="" style="color: white;">Cargos com Vagas Abertas</a>
                <a href="listaCargosSemVagas.jsp" class="grey lighten-5 waves-effect waves-light btn col s6" value="" style="color: gray;">Cargos sem Vagas Abertas</a>
            </div>
                            ...
                            <table class="highlight">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="abrirVagas.jsp?idCargo=<%=c.getIdCargo()%>" class="btn-floating btn waves-effect waves-light indigo "><i class="material-icons">add</i></a>
                                        </td>

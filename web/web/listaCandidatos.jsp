            ...
            <table class="highlight">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="scripts/excluirCandidato.jsp?idV=<%=c.getIdPessoa()%>" class="waves-effect waves-indigo darken-3 btn-flat "><i class="material-icons right">delete</i>Excluir</a>
                        </td>

...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <%} else { %>
            <div class="row">
                <a href="listaCandidatos.jsp" class="  light-blue darken-4 waves-effect waves-light btn col s6" value="" style="color: white;">Candidatos Habilitados</a>
                <a href="telaHabilitarCandidatos.jsp" class="grey lighten-5 waves-effect waves-light btn col s6" value="" style="color: gray;">Candidatos Desabilitados</a>
            </div>
            <br>
            <div class="container" >
                                ...
                                <table class="highlight" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            %>
                                            <td>Não possui formações profissionais</td>
                                            <%  }else if(c.getFormacoesProfissionais().equals("")) { %>
                                                  <td>Não possui formações profissionais</td>
                                                <%
                                                } else {%> 

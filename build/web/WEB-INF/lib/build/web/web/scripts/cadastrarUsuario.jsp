    ...
    <body>
        <%
            ...
            if (tipoUsuario.equals("funcionario")) {
                ...
                /**
                 * Funcionario f =
                 * controle.consultarFuncionarioPorMatricula(matricula); if (f
                 * != null) {
                 */
                Usuario u = new Usuario(nomeUsuario, senha, tipoUsuario);
                Funcionario f =new Funcionario(matricula, "funcionario", new Date(), tipoUsuario, 0, "", "", "", "", "");
                ControleUsuario controleUsuario = new ControleUsuario();
                controleUsuario.inserirUsuario(u);
                controle.inserirFuncionario(f);
                response.sendRedirect("../login.jsp");
            } else {
                Usuario u = new Usuario(nomeUsuario, senha, tipoUsuario);
                Curriculo curriculo = new Curriculo(0, new Date(), new File(""));
                Candidato c = new Candidato("", "", "", "", nomeUsuario, senha, tipoUsuario);

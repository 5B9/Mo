                            ...
                            <table class="highlight">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="scripts/agendamentoExcluir.jsp?idAgendamento=<%=a.getIdSessao()%>" class="btn-floating btn waves-effect waves-light indigo "><i class="material-icons">delete</i></a>
                                        </td>
                                        <td>
                                            <!-- Modal Trigger -->
                                            ...
                                            <div id="modal1" class="modal modal-fixed-footer">
                                                <div class="modal-content">
                                                    <h4>Entrevista do dia <%=sdf.format(a.getDataSessao().getTime())%></h4>
                                                    <%//for (Entrevista e : a.getEntrevistas()) {%>
                                                    <p>s</p>
                                                    <%//}%>
                                                </div>
